        ...
        <>
            <div className='Body'>
                <section className='About'>
                    <h1>About Us</h1>
                    <p>At [Your Company Name], we believe that a suit is much more than just an outfit—it's a statement of professionalism, confidence, and style. Founded in [Year] with the vision of bringing high-quality, bespoke suits to the modern professional, we've dedicated ourselves to crafting garments that not only fit perfectly but also stand the test of time. Our suits are designed with a keen eye for detail, utilizing only the finest fabrics sourced from renowned mills around the world. Whether you're preparing for a pivotal moment in your career or celebrating a personal milestone, our collection is curated to ensure that every individual can find a suit that matches not just their measurements, but their personality and lifestyle as well. At [Your Company Name], we're not just selling suits—we're equipping you for success and moments that matter.</p>
